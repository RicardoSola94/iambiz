...
class EditInventoryScreen extends ConsumerStatefulWidget {
  ...
  @override
  EditInventoryScreenState createState() => EditInventoryScreenState();
}

class EditInventoryScreenState extends ConsumerState<EditInventoryScreen> {
  ...
  void initState() {
    ...
    minQuantityController.text = widget.inventory.minQuantity.toString();
    purchasePriceController.text = widget.inventory.purchasePrice.toString();
    salePriceController.text = widget.inventory.salePrice?.toString() ?? '';
    selectedCategoria = widget.inventory.category;
    selectedUnit = widget.inventory.unit;
  }
  ...
  String? validateNumber(String value) {
    ...
    if (number < 0) return 'Debe ser mayor o igual a 0';
    return null;
  }
