...
import '../../../../config/theme/default_theme.dart';
import '../../../../domain/entities/inventory/inventory_model.dart';
import '../../../../domain/entities/producto_cotizado.dart/producto_cotizado_model.dart'
    show ProductoCotizado;
...
class QuoteEditSelectProductsScreen extends ConsumerStatefulWidget {
  const QuoteEditSelectProductsScreen({super.key});

  @override
  ConsumerState<QuoteEditSelectProductsScreen> createState() =>
      _QuoteEditSelectProductsScreenState();
}

class _QuoteEditSelectProductsScreenState
    extends ConsumerState<QuoteEditSelectProductsScreen> {
